...
Kimi Linear Hugging Face repo, for manually validating src/kimi_linear/tokenizer.rs against the
real ~163,840-entry vocab — the sibling of `fetch_tokenizer_fixture.py`'s GLM-5.2 version.
...
Usage:
    ...
    python3 tools/fetch_kimi_tokenizer_fixture.py                # -> tests/fixtures/kimi/
    python3 tools/fetch_kimi_tokenizer_fixture.py --dest DIR
"""
...
def main():
    ...
    ap.add_argument(
        "--dest",
        default=os.path.join(os.path.dirname(__file__), "..", "tests", "fixtures", "kimi"),
        help="destination directory (default: tests/fixtures/kimi)",
    )
    args = ap.parse_args()
